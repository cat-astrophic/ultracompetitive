...
for (it in 1:1000) {
  ...
  DM <- rnorm(10000, mean = 95, sd = 10)
  DF <- rnorm(10000, mean = 100, sd = 10)
...
ggplot(data = sim.df, aes(Values, fill = Gender)) + 
  ...
  scale_x_continuous(breaks = c(40, 60, 80, 95, 100, 120, 140, 160), labels = c(40, 60, 80, 95, 100, 120, 140, 160))
...
for (it in 1:1000) {
  ...
  DM2 <- rnorm(10000, mean = 95, sd = 10)
  DF2 <- rnorm(10000, mean = 100, sd = 10)
...
for (it in 1:1000) {
  ...
  DM3 <- rnorm(10000, mean = 95, sd = 10)
  DF3 <- rnorm(10000, mean = 100, sd = 10)
